...
func renderStatus(t Theme, in StatusIn, rows []string, tagline string) string {
	b := renderTitle(t, rows, tagline)
	if in.Session != "" {
...
func renderTitle(t Theme, rows []string, tagline string) string {
