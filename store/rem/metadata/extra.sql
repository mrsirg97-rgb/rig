-- What the DDL camera cannot emit (SPEC_STATE, decisions), per pane's
-- schema: the natural-key unique index (idempotent create), the recall
-- ordering spine, and the trigram seek indexes.
